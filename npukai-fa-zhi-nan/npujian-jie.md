...
GXDNN用于将用户生成的Tensorflow模型编译成可以被NPU硬件模块执行的指令，并提供了一套API让用户方便地运行Tensorflow模型。![](/assets/32bbd801cb5134b0cdbb685b54c0cce6.jpg) 图：gxDNN神经网络处理器的作用
...
![](/assets/9cbd3d61d2e48d9d5d57cc6f97fce42b.jpg)
